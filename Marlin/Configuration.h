...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-3 Pro/BTT SKR 1.4 Turbo (TMC2209)"
...
#define STRING_CONFIG_H_AUTHOR "(rsamofals, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3-Pro-BTT-SKR1.4T"
